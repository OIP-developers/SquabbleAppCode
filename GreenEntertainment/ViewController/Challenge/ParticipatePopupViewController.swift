//
//  ParticipatePopupViewController.swift
//  GreenEntertainment
//
//  Created by Prempriya on 07/04/21.
//  Copyright © 2021 Quytech. All rights reserved.
//

import UIKit

protocol CustomSelectionDelegate {
    func agreeTermsAndConditions(status: Bool, obj: HomeModel)
    func clickedTermsAndConditions(obj: HomeModel)
}


class ParticipatePopupViewController: UIViewController {
    ...
    var delegate: CustomSelectionDelegate?
    var obj = HomeModel()
...
extension ParticipatePopupViewController {
